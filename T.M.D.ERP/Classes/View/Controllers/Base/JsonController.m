...
-(void) requestForModelDataFromServer
{
    ...
    [MODEL.requester startPostRequestWithAlertTips:requestModel completeHandler:^(HTTPRequester* requester, ResponseJsonModel *data, NSHTTPURLResponse *httpURLReqponse, NSError *error) {
        [VIEW.progress hide];
...
-(void) didSuccessApplyOrder: (NSString*)orderType appFrom:(NSString*)appFrom appTo:(NSString*)appTo divViewKey:(NSString*)divViewKey forwarduser:(NSString*)forwardUser
{
    ...
    [self.valueObjects setObject: MODEL.signedUserName forKey:appFrom];
