    ...
    for (int i = 0; i < caculateFields.count; i++) {
        ...
        view.textField.textFieldShouldSetTextBlock = ^BOOL(NormalTextField* textField, NSString* newText) {
            ...
            if (isNumeric) {
                ...
                [AppViewHelper alertMessage: LOCALIZE_MESSAGE_FORMAT(MESSAGE_ValueNotMatchFormat, LOCALIZE_KEY(LOCALIZE_CONNECT_KEYS(self.order, view.attribute)), LOCALIZE_KEY(json_CHECK_FORMAT_DIGIT))];
                return NO;
            }
        };
