...
-(NSArray*) requestTableFromModel:(RequestJsonModel*)model toTable:(NSString*)tableName{
    [MODEL.requester startPostRequest:model completeHandler:^(HTTPRequester *requester, ResponseJsonModel *model, NSHTTPURLResponse *httpURLReqponse, NSError *error) {
        NSLog(@"gatcha");
