...
-(void)setTextFieldDidClickAction
{
    ...
    _projectNameTxtField.textFieldDidClickAction = ^void(JRTextField* jrTextField){
        ...
        NSArray* needFields = @[@"purpose",@"productCode",@"productName",@"pickingAmount",@"unit",@"pickingStaff",@"recycleAmount"];
        PickerModelTableView* pickView = [PickerModelTableView popupWithRequestModel:ORDER_WHPickingOrder fields:needFields ];
