...
- (void)viewDidLoad
{
    self.approvalsView.initializeSubViewsBlock = ^void(ApprovalsViews* appview) {
        for (int i = 0; i < appview.approvals.count; i++) {
            ...
            leaveDayView.frame = [FrameTranslater convertCanvasRect: CGRectMake(0, 500, 500, 60)];
            ...
            dayTextField.frame = [FrameTranslater convertCanvasRect: CGRectMake(150, 15, 100, 30)];
