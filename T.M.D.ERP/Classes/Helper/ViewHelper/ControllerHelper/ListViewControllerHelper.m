...
{
    return [TableViewBaseContentHelper iterateContentsToCell: realContentsDictionary handler:^(int index, int innerCount, int outterCount, NSString* section, id obj, NSMutableArray *cellRep) {
...
{
    BOOL isHaveExceptionCloumn = [[MODEL.modelsStructure getModelProperties: order] containsObject: PROPERTY_EXCEPTION];
