...
{
    // send
    [MODEL.requester startDownloadRequest: IMAGE_URL(DOWNLOAD) parameters:@{@"PATH":imagePath} completeHandler:^(HTTPRequester *requester, ResponseJsonModel *model, NSHTTPURLResponse *httpURLReqponse, NSError *error) {
        UIImage* image = [UIImage imageWithData: model.binaryData];
...
+(void) deleteImagesFolder:(NSString*)folderPath completeHandler:(void(^)(HTTPRequester *requester, ResponseJsonModel *model, NSHTTPURLResponse *httpURLReqponse, NSError *error))completeHandler
{
    ...
    [MODEL.requester startPostRequest:IMAGE_URL(@"delete") parameters:@{@"Folder": folderPath} completeHandler:^(HTTPRequester *requester, ResponseJsonModel *model, NSHTTPURLResponse *httpURLReqponse, NSError *error) {
        if (completeHandler) {
