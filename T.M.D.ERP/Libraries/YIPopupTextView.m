...
- (id)initWithPlaceHolder:(NSString*)placeHolder maxCount:(NSUInteger)maxCount
{
    ...
    if (self) {
        ...
        CGFloat valid_width = [UIScreen mainScreen].bounds.size.width * 3/4;
        CGFloat valid_height = [UIScreen mainScreen].bounds.size.height /4;
        _popupView = [[UIView alloc] initWithFrame:CGRectMake(valid_width/5, 50, valid_width, valid_height)];
...
//        self.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        ...
        _closeButton.frame = CGRectMake(0, 50, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
        ...
        _closeButton.frame = CGRectMake(_popupView.bounds.size.width-TEXTVIEW_INSETS.right-CLOSE_IMAGE_WIDTH-valid_width/7,
                                        50,
                                        CLOSE_BUTTON_WIDTH, 
                                        CLOSE_BUTTON_WIDTH);
